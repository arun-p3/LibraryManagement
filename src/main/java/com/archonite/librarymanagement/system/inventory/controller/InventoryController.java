...
public class InventoryController {
    ...
    public ResponseEntity<OrderResponse> lend(@RequestParam("accountId") String accountId,
                                              @RequestBody List<BookRequestDto> bookRequestDto) throws BookUnAvailabilityException {
    ...
    public ResponseEntity<String> returnBook(@RequestHeader("Authorization") String token,
                                         @RequestParam UUID accountId, @RequestParam UUID orderId) throws BookUnAvailabilityException {
